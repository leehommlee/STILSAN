...
class datapreprocess():
    ...
    def __init__(self,datafilepath,savefileRootpath,dataname,min_checkins, interval_hour,scope,max_users):
        ...
        self.saveAdjfilepath=savefileRootpath+'adj'+dataname+'.npz'
        ...
        self.saveAdj_D_filepath=savefileRootpath+'adj_D_'+dataname+'.npz'
    ...
    def create(self):
        self.createAdjnpz()
        self.load_adj_distance()

    def create_V(self):
        self.load_adj_distance_V()

    def createBipartite(self):
        self.createAdjnpzBipartite()
    ...
    def load_adj_distance_V(self):
        users, times, coords, locs, adj = self.gowalla.load_adj_V()
